Welcome to OwlContext!

OwlContext is your Context-Aware AI Partner
...
After enabling Recording, OwlContext will periodically capture screenshots for analysis (the interval time can be adjusted in Settings), summarizing your activity every 15 minutes.

You can view previous activities by switching the date.

## Home

Home is where OwlContext proactively delivers your daily summaries, todos, tips and other insights—emerging from all your collected Contexts.

### Todo

OwlContext will automatically generate todos based on your context. You can delete or edit them.

### Tip

OwlContext generates tips to help you uncover insights behind the context.

### Summary

OwlContext generates a daily/weekly summary every day at 8 PM and every Sunday at 8 PM, allowing you to review your activities more clearly.
